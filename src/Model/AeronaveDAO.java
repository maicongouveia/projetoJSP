...
public class AeronaveDAO {
	...
	public void cadastraAeronave(AeronaveTO aero) {
		try {
			Conexao bd = new Conexao();
			Connection conn = bd.obtemConexao();
	...
	public void alterarAeronave(AeronaveTO aero) {
	...
	public List<AeronaveTO> pesquisar() {
		
		ArrayList resultadoPesquisa = new ArrayList<AeronaveTO>();
	...
	public AeronaveTO consultaAeronave(int codigo){
		String query;
