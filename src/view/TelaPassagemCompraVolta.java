...
public class TelaPassagemCompraVolta extends JDialog implements ActionListener{
	...
	public TelaPassagemCompraVolta(final ResourceBundle bundle,JFrame p, int vooSelecionado) {
		
		super(p,true);
		
		setTitle("Passagem - Compra Volta");
	...
	public void pesquisar(){		
		VooBD bd = new VooBD();
		modelo = (DefaultTableModel) bd.pesquisarVooCompraVolta(tabelaResultado.getModel(), vooSelecionado);		
	}
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == btProximo){
			dispose();
			TelaPassagemCompraQtdPassageiros tela = new TelaPassagemCompraQtdPassageiros(bundle, null, vooSelecionado, tabelaResultado.getSelectedRow());
